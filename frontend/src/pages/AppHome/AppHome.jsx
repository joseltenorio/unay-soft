...
const ACTIVITY = [
  { id: 1, icon: CheckCircle,    color: "teal",  title: "Orden #ORD-0041 pagada",       sub: "Cajero · Marcos Salazar",      time: "hace 3 min"  },
  { id: 2, icon: UtensilsCrossed,color: "amber", title: "Mesa 3 abierta en salón",      sub: "Mozo · Lucía Mejía",           time: "hace 8 min"  },
...
const roleContent = {
  Administrador: {
    ...
    flow: ["Entrar a Usuarios.", "Crear o editar cuentas.", "Validar acceso por perfil.", "Cerrar sesión al finalizar."],
  ...
  Gerente: {
    ...
    pending: ["Revisar el estado de caja.", "Validar inventario crítico.", "Consultar reportes del día.", "Supervisar salón y cocina."],
    flowTitle: "Áreas clave",
    flow: ["Salón y pedidos.", "Caja y pagos.", "Inventario e insumos.", "Reportes operativos."],
  ...
  Cajero: {
    ...
    pending: ["Revisar pagos pendientes.", "Validar comprobantes.", "Preparar cierre del turno.", "Confirmar operaciones."],
    flowTitle: "Flujo recomendado",
    flow: ["Abrir caja.", "Registrar pagos.", "Validar comprobantes.", "Cerrar turno."],
    primaryAction: { label: "Ir a caja", to: "/app/cashier" },
    secondaryAction: { label: "Ir a POS", to: "/app/pos" },
  },
  Mozo: {
    pendingTitle: "Pendientes de salón",
    pending: ["Registrar pedidos de mesa.", "Enviar comandas a cocina.", "Coordinar pedidos listos.", "Derivar pagos a caja."],
    flowTitle: "Flujo recomendado",
    flow: ["Seleccionar mesa.", "Agregar productos.", "Enviar comanda.", "Coordinar pago."],
    primaryAction: { label: "Ir a POS / Salón", to: "/app/pos" },
    secondaryAction: null,
  },
  Cocina: {
    pendingTitle: "Pendientes de cocina",
    pending: ["Revisar pedidos nuevos.", "Priorizar pedidos antiguos.", "Actualizar estados.", "Avisar pedidos listos."],
    flowTitle: "Flujo recomendado",
    flow: ["Tomar pedido.", "Marcar en preparación.", "Finalizar pedido.", "Despachar a salón."],
...
const defaultRoleContent = {
  ...
  pending: ["Revisar accesos asignados.", "Ingresar al módulo.", "Reportar accesos faltantes."],
  flowTitle: "Flujo recomendado",
...
export default function AppHome() {
  ...
  const [adminStats, setAdminStats] = useState({ activeUsers: null, inactiveUsers: null })
  ...
  const kpis = [
    ...
    },
    {
      ...
      value: adminStats.activeUsers !== null ? String(adminStats.activeUsers) : String(modules.length > 0 ? 6 : 0),
      trend: "+2",
      trendUp: true,
    },
    {
    ...
    <div className="ah">
          ...
          return (
            <div key={kpi.label} className="ah__kpi">
              <div className="ah__kpi-top">
                ...
                <span className={`ah__kpi-trend ${kpi.trendUp ? "ah__kpi-trend--up" : "ah__kpi-trend--down"}`}>
                  {kpi.trendUp
      ...
      <div className="ah__grid2">
        ...
        <div className="ah__card">
          ...
          <div className="ah__legend">
            <span className="ah__leg-item"><span className="ah__leg-sq ah__leg-sq--dark" />Ingresos</span>
            <span className="ah__leg-item"><span className="ah__leg-sq ah__leg-sq--teal" />Hoy</span>
          </div>

          <ResponsiveContainer width="100%" height={168}>
            <BarChart data={SALES_DATA} barSize={26} margin={{ top: 4, right: 0, left: -10, bottom: 0 }}>
              <XAxis
                dataKey="day"
                axisLine={false}
                tickLine={false}
              ...
              <YAxis
                ...
                width={38}
              />
              <Tooltip content={<CustomTooltip />} cursor={{ fill: "rgba(3,25,38,0.04)" }} />
              <Bar dataKey="ingresos" radius={[6, 6, 0, 0]}>
                {SALES_DATA.map((entry) => (
                  <Cell key={entry.day} fill={entry.day === "Hoy" ? "#77aca2" : "#031926"} />
                ))}
              </Bar>
            </BarChart>
          </ResponsiveContainer>
      ...
      <div className="ah__card">
        <div className="ah__card-header">
          ...
          <button className="ah__card-pill ah__card-pill--btn">Ver todos</button>
        </div>
      ...
      <div className="ah__panels">
        ...
        <div className="ah__panel ah__panel--accent">
          ...
          <div className="ah__access">
            <div><span>Permisos</span><strong>{permissions.length}</strong></div>
            <div><span>Módulos</span><strong>{modules.length}</strong></div>
            <div><span>Sesión</span><strong>Activa</strong></div>
          </div>
        </div>
